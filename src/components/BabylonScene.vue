<template>  
  ...
  <div class="absolute top-2 left-2 bg-white w-16 h-16 rounded-full flex justify-center items-center" @click="afficherMenu">
...
export default defineComponent({
    ...
    return {
      ...
      questions : [
        new Question(
          ...
          [
            "Les deux tombent au même moment",
            "La bille rouge",
            "La bille bleu", 
          ]
        ),
  ...
  mounted(){
    ...
    this.experience1 = new Experience1(canvas, this.setLoaded,this.voirCard,this.voirQuestion);    
  },
  methods: {
    setLoaded() {
      this.loaded = true;
