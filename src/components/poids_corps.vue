<template>
    ...
    <main :class="{'blur-sm': flou == true}">
        ...
        <div class="absolute top-2 left-2 bg-white w-16 h-16 rounded-full flex justify-center items-center cursor-pointer">
        ...
        <div class="absolute bottom-2 left-2 bg-white w-16 h-16 rounded-full flex justify-center items-center cursor-pointer">
